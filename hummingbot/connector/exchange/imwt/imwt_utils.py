...
class IMWTConfigMap(BaseConnectorConfigMap):
    connector: str = Field(default="imwt", const=True, client_data=None)
#    opencex_api_key: SecretStr = Field(
    imwt_api_key: SecretStr = Field(
        default=...,
        client_data=ClientFieldData(
            prompt=lambda cm: "Enter your IMWT API key",
            is_secure=True,
            is_connect_key=True,
            prompt_on_new=True,
        ),
...
#    opencex_secret_key: SecretStr = Field(
    imwt_secret_key: SecretStr = Field(
        default=...,
        client_data=ClientFieldData(
            prompt=lambda cm: "Enter your IMWT secret key",
            is_secure=True,
            is_connect_key=True,
            prompt_on_new=True,
        ),
...
KEYS = IMWTConfigMap.construct()


#def get_opencex_order_state(order_data):
def get_imwt_order_state(order_data):
