...
from hummingbot.connector.exchange.imwt import imwt_constants as CONSTANTS
...
class IMWTAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    async def _connected_websocket_assistant(self) -> WSAssistant:
        ...
        async with self._api_factory.throttler.execute_task(limit_id=CONSTANTS.WS_CONNECTION_LIMIT_ID):
            await ws.connect(
                ws_url=CONSTANTS.IMWT_WS_URI_PRIVATE,
